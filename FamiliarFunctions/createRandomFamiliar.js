...
function createRandomFamiliar(imgArray, difficulty){
    ...
    let constitution = parseFloat(Math.floor(Math.random() * (randomNumber(20) +10)* difficulty));
    let dexterity = (Math.floor(Math.random() * randomNumber(20)+ 10) * difficulty);
    let strength = (Math.floor(Math.random() * randomNumber(20)+ 10) * difficulty);
    let charisma = (Math.floor(Math.random() * randomNumber(20)+ 10));
    let willpower = (Math.floor(Math.random() * randomNumber(20)+ 10));
    let intelligence = (Math.floor(Math.random() * randomNumber(20)+ 10));
    let defense = (Math.floor(Math.random() * randomNumber(20)+ 10));
    let speed = 0;
